...
import pinturerias from "../data/APP_CAdh_div_pinturerias.svg";
import map from "../data/ubicacionVerdeClaro.svg";
import wp from "../data/wpVerdeClaro.svg";
import localizacion from "../data/mapa.svg"

export default function Pinturerias() {
  return (
    <div>
      <h1 className="centrar verdeClaro">PINTURERIAS</h1>
      ...
      <div className="card-deck row row-cols-1 row-cols-md-3 g-4">
        {datas.COMERCIOS.map((data) =>
          data.RUBRO === "PINTURERIA" ? (
            <div>
              <div className="card text-white border-0">
                <img src={pinturerias} className="card-img" />
