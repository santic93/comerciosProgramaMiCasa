...
import electricidad from "../data/APP_CAdh_div_electricidad.svg";
...
export default function Electricidad() {
  return (
    <div>
    <h1 className="centrar azul">ELECTRICIDAD</h1>
    ...
    Consulta donde podes comprar tus materiales con la tarjeta Cabal de los
      ...
      <div className="card-deck row row-cols-1 row-cols-md-3 g-4">
        {datas.COMERCIOS.map((data) =>
          data.RUBRO === "ELECTRICIDAD" ? (
            <div>
              <div className="card text-white border-0">
                <img src={electricidad} className="card-img" />
