...
import constructoras from "../data/APP_CAdh_div_construccion.svg";
...
export default function Constructoras() {
  return (
    <div>
      <h1 className="centrar verdeOscuro">CONSTRUCTORAS</h1>
      ...
      <div className="card-deck row row-cols-1 row-cols-md-3 g-4">
        {datas.COMERCIOS.map((data) =>
          data.RUBRO === "CONSTRUCTORA" ? (
            <div>
              <div className="card text-white border-0">
                <img src={constructoras} className="card-img" />
