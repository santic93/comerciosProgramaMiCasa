...
import sanitarios from "../data/APP_CAdh_div_sanitarios.svg";
...
export default function Sanitarios() {
  return (
    <div>
      <h1 className="centrar verde">SANITARIOS</h1>
      ...
      <div className="card-deck row row-cols-1 row-cols-md-3 g-4">
        {datas.COMERCIOS.map((data) =>
          data.RUBRO === "SANITARIOS" ? (
            <div>
              <div className="card text-white border-0">
                <img src={sanitarios} className="card-img" />
