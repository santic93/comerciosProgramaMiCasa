...
import vidrierias from "../data/APP_CAdh_div_vidrierias.svg";

export default function Vidrierias() {
  return (
    <div>
      <h1 className="centrar verdeClaro">VIDRIERIAS</h1>
      ...
      <div className="card-deck row row-cols-1 row-cols-md-3 g-4">
        {datas.COMERCIOS.map((data) =>
          data.RUBRO === "VIDRIERIAS" ? (
            <div>
              <div className="card text-white border-0">
                <img src={vidrierias} className="card-img" />
